...
СЛОЙ 2 — CANON (до кода)
  Какой канон нужен для этого типа проекта? Палитра? Типографика? Density?
  → /Users/alex/Projects/platform/docs/design/marketing.design.md
  ИЛИ /Users/alex/Projects/platform/docs/design/product.design.md
...
```
STEP 0 (mandatory before any UI code):
  Маркетинг/лендинг/Vedantica -> Read /Users/alex/Projects/platform/docs/design/marketing.design.md
  Admin/CRM/sales/dashboard   -> Read /Users/alex/Projects/platform/docs/design/product.design.md
  ИЛИ                          mcp__untitledui__list_components / get_example

IF новая страница или крупный блок:
  READ design-principles.md → relevant *.design.md → page-layouts.md
...
IF цвет:
  ...
  Маркетинг (vedantica.pro, лендинги): marketing.design.md палитра
...
| `/Users/alex/Projects/platform/docs/design/marketing.design.md` | Канон Vedantica marketing: mood, палитра, типографика, editorial spacing | Маркетинг-сайт, лендинги, editorial |
| `/Users/alex/Projects/platform/docs/design/product.design.md` | Канон Veda Product: product tokens, density, hierarchy, operational patterns | Admin, CRM, sales, dashboards |
